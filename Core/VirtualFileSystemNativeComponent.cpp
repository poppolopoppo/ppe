...
UniquePtr<IVirtualFileSystemIStream> VirtualFileSystemNativeComponent::OpenReadable(const Filename& filename, AccessPolicy::Mode policy) {
    ...
    UniquePtr<IVirtualFileSystemIStream> result(new VirtualFileSystemNativeFileIStream(nativeFilename, policy));
    return result;
}
//----------------------------------------------------------------------------
bool VirtualFileSystemNativeComponent::CreateDirectory(const Dirpath& dirpath) {
    ...
    result |= CreateDirectory_(nativeDirpath);
...
UniquePtr<IVirtualFileSystemOStream> VirtualFileSystemNativeComponent::OpenWritable(const Filename& filename, AccessPolicy::Mode policy) {
    ...
    UniquePtr<IVirtualFileSystemOStream> result(new VirtualFileSystemNativeFileOStream(nativeFilename, policy));
    return result;
}
//----------------------------------------------------------------------------
