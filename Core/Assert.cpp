...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
static MessageBox::Result AssertAbortRetryIgnore_(const char *msg, const wchar_t *file, unsigned line) {
    Callstack callstack;
    ...
    return MessageBox::AbortRetryIgnore(text, L"Assert failed !", MessageBox::Icon::Exclamation);
}
//----------------------------------------------------------------------------
...
void AssertionFailed(const char *msg, const wchar_t *file, unsigned line) {
    ...
    if (handler) {
        ...
        case MessageBox::Result::Abort:
            failure = true;
            break;
        case MessageBox::Result::Retry:
            if (IsDebuggerAttached_())
                BREAKPOINT();
            break;
        case MessageBox::Result::Ignore:
            failure = false;
            break;
        default:
            AssertNotReached();
