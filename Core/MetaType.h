...
struct MetaType< RTTI::Pair<_First, _Second> > {
    ...
    static const char *Name() {
        static const StaticFormat<char, 128> gName("Pair<{0},{1}>", first_meta_type::Name(), second_meta_type::Name());
        return gName.c_str();
    }
...
struct MetaType< RTTI::Vector<T> > {
    ...
    static const char *Name() {
        static const StaticFormat<char, 128> gName("Vector<{0}>", value_meta_type::Name());
        return gName.c_str();
    }
...
struct MetaType< RTTI::Dictionary<_Key, _Value> > {
    ...
    static const char *Name() {
        static const StaticFormat<char, 128> gName("Dictionary<{0},{1}>", key_meta_type::Name(), value_meta_type::Name());
        return gName.c_str();
    }
