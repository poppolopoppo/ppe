...
#define DBGHELP_TRANSLATE_TCHAR         // http://msdn.microsoft.com/en-us/library/windows/desktop/ms681400(v=vs.85).aspx
#define WIN32_LEAN_AND_MEAN             // Exclure les en-têtes Windows rarement utilisés
#define VC_EXTRALEAN                    // Exclure les en-têtes Windows rarement utilisés (MFC)
