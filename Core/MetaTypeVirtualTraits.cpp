...
const MetaTypeScalarTraits *MetaTypeScalarTraits::Instance() {
    static const MetaTypeScalarTraits gInstance;
    return &gInstance;
}
//----------------------------------------------------------------------------
...
const MetaTypePairTraits *MetaTypePairTraits::Instance() {
    static const MetaTypePairTraits gInstance;
    return &gInstance;
}
//----------------------------------------------------------------------------
...
const MetaTypeVectorTraits *MetaTypeVectorTraits::Instance() {
    static const MetaTypeVectorTraits gInstance;
    return &gInstance;
}
//----------------------------------------------------------------------------
...
const MetaTypeDictionaryTraits *MetaTypeDictionaryTraits::Instance() {
    static const MetaTypeDictionaryTraits gInstance;
    return &gInstance;
}
//----------------------------------------------------------------------------
