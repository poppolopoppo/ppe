...
#include "Core/DecodedCallstack.h"
#include "Core/Heap.h"
...
#include "Core/CrtDebug.h"

#include "Core/ThreadContext.h"
#include "Core/ThreadLocalStorage.h"

#include "Core/LockFreeCircularArray.h"
...
#include "Core/VirtualFileSystemNativeComponent.h"
...
#include "Core/RTTIMacros-impl.h"

#include "Core/Lexer.h"
#include "Core/SymbolTrie.h"
...
#include "Core/ScalarBoundingBox.h"
#include "Core/ScalarBoundingBoxHelpers.h"
...
void TestVirtualFileSystem_() {
    ...
    vfs.CreateDirectory(L"process:/tmp/1/2/3");
...
#include "Core.Application/KeyboardKey.h"
#include "Core.Application/MouseButton.h"
