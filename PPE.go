...
func (x BuildVersionHeader) Generate(bc BuildContext, u *Unit, dst io.Writer) {
	sourceControl := SourceControlBuilder.Need(bc)
	fmt.Fprintln(dst, "#pragma once")
	fmt.Fprintln(dst, "// Build version generated by "+MAIN_SIGNATURE+"/"+u.Target.String()+" on "+time.Now().String())
