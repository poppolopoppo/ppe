...
func (x SpirvToolsGeneratedHeader) Generate(bc BuildContext, generated *BuildGenerated, dst io.Writer) error {
	...
	cpp.Comment("SPIRV-Tools header generated by %v - spirvtools v%v", PROCESS_INFO, x.Version)
	cpp.Pragma("once")
...
func getSpirvToolsExtractor(download *Downloader, extractDir Directory) BuildFactoryTyped[*CompressedArchiveExtractor] {
