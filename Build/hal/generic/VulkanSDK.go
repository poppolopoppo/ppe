...
var Vulkan = RegisterArchetype("SDK/VULKAN", func(rules *ModuleRules) {
	rules.Generate(PUBLIC, "vulkan-exports.generated.h", &VulkanHeaderGenerator{
		Version: VulkanHeaderVersion,
	})
	rules.Generate(PRIVATE, "vulkan-exports.generated.cpp", &VulkanSourceGenerator{
		Version:         VulkanSourceVersion,
		GeneratedHeader: "vulkan-exports.generated.h",
	})
})

func getVulkanBindingsFile(unit *Unit) Filename {
	return unit.ModuleDir.AbsoluteFile(unit.Exports.Get("Vulkan/Bindings"))
}
func getVulkanIncludeDir(unit *Unit) Directory {
...
func (x *VulkanHeaderGenerator) Serialize(ar Archive) {
	ar.String(&x.Version)
}
func (x VulkanHeaderGenerator) CreateGenerated(unit *Unit, output Filename) Generated {
...
func (x *VulkanGeneratedHeader) Serialize(ar Archive) {
	ar.String(&x.Version)
	ar.Serializable(&x.BindingsFile)
	ar.Serializable(&x.IncludeDir)
}
func (g VulkanGeneratedHeader) Generate(bc BuildContext, generated *BuildGenerated, dst io.Writer) error {
	...
	cpp.Comment("Vulkan header generated by %v - vulkan v%v", CommandEnv.Prefix(), VulkanHeaderVersion)
	cpp.Pragma("once")
	cpp.Include("Container/BitMask.h")
	for _, x := range vk.Headers {
		cpp.Include(SanitizePath(x.Relative(UFS.Source), '/'))
	}
...
func (x *VulkanSourceGenerator) Serialize(ar Archive) {
	ar.String(&x.Version)
	ar.String(&x.GeneratedHeader)
}
func (x VulkanSourceGenerator) CreateGenerated(unit *Unit, output Filename) Generated {
...
func (x *VulkanGeneratedSource) Serialize(ar Archive) {
	ar.String(&x.Version)
	ar.String(&x.GeneratedHeader)
	ar.Serializable(&x.BindingsFile)
	ar.Serializable(&x.IncludeDir)
}
func (g VulkanGeneratedSource) Generate(bc BuildContext, generated *BuildGenerated, dst io.Writer) error {
	vk, err := GetVulkanInterface(VulkanInterfaceParams{g.IncludeDir, g.BindingsFile}).Need(bc)
	if err != nil {
		return err
	}
	...
	cpp := NewCppFile(dst, false)
	cpp.Comment("Vulkan source generated by %v - vulkan v%v", CommandEnv.Prefix(), VulkanSourceVersion)
	cpp.Pragma("once")
...
func (v *VkBindingType) Serialize(ar Archive) {
	ar.String((*string)(v))
}
...
func (b *VkBinding) Serialize(ar Archive) {
...
func (x *VkEnumValue) Serialize(ar Archive) {
	ar.String(&x.Key)
	ar.Int32(&x.Value)
}
...
func (x *VkEnum) Serialize(ar Archive) {
	ar.String(&x.Name)
	SerializeSlice(ar, &x.Values)
}
...
func (a *VkFunctionArg) Serialize(ar Archive) {
	ar.String(&a.Name)
	ar.String(&a.Type)
}
...
func (f *VkFunctionPointer) Serialize(ar Archive) {
	ar.String(&f.Name)
	ar.String(&f.Return)
	SerializeSlice(ar, &f.Args)
}
...
func vkParseFunctionPointers(filename Filename) ([]VkFunctionPointer, error) {
	results := []VkFunctionPointer{}
	err := UFS.Scan(filename, re_VkFunctionPointer, func(m []string) error {
...
func (vk *VulkanHeaders) Build(bc BuildContext) error {
	...
	if functions, err := ParallelMap(vkParseFunctionPointers, vk.Headers...); err == nil {
...
func (vk *VulkanHeaders) Serialize(ar Archive) {
	ar.Serializable(&vk.Src)
	ar.Serializable(&vk.Headers)
	SerializeSlice(ar, &vk.Enums)
	SerializeSlice(ar, &vk.Functions)
}
...
func (ext *VkExtension) Serialize(ar Archive) {
	ar.String(&ext.Name)
	ar.Serializable(&ext.Foreign)
	ar.Serializable(&ext.Requires)
	SerializeMany(ar, ar.Int32, &ext.Aliases)
	SerializeMany(ar, ar.Int32, &ext.Functions)
}
...
func (fn *VkFunction) Serialize(ar Archive) {
	ar.String(&fn.Requires)
	ar.String(&fn.Version)
	SerializeExternal(ar, &fn.VkFunctionPointer)
}
...
func (fn *VkFunctionAlias) Serialize(ar Archive) {
	ar.Int32(&fn.From)
	ar.Int32(&fn.To)
	ar.String(&fn.Version)
}
...
func (vk *VulkanInterface) GetHeaders(bc BuildContext) (*VulkanHeaders, error) {
	return GetVulkanHeaders(vk.IncludeDir).Need(bc)
}
func (vk *VulkanInterface) GetBindings(bc BuildContext) (*VulkanBindings, error) {
...
func (vk *VulkanInterface) Serialize(ar Archive) {
	...
	SerializeSlice(ar, &vk.EnumTypes)
	SerializeSlice(ar, &vk.ExportedFuncs)
	SerializeSlice(ar, &vk.GlobalFuncs)
	SerializeSlice(ar, &vk.InstanceFuncs)
	SerializeSlice(ar, &vk.InstanceExts)
	SerializeSlice(ar, &vk.InstanceBwds)
	SerializeSlice(ar, &vk.DeviceFuncs)
	SerializeSlice(ar, &vk.DeviceExts)
	SerializeSlice(ar, &vk.DeviceBwds)
}
