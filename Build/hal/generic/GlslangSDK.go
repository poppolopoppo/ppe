...
func (x GlslangGeneratedHeader) Generate(bc BuildContext, generated *BuildGenerated, dst io.Writer) error {
	...
	cpp.Comment("Glslang header generated by %v -- glslang v%v", PROCESS_INFO, x.Version)
	cpp.Pragma("once")
...
func getGlslangExtractor(download *Downloader, extractDir Directory) BuildFactoryTyped[*CompressedArchiveExtractor] {
