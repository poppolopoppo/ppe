...
public: // interface
    ...
    virtual void PushConstants(const FPushConstantID& id, const void* data, size_t size) = 0;
    ...
    virtual void BindVertexBuffer(const FVertexBufferID&id, FRawBufferID buffer, size_t offset) = 0;
    ...
    virtual void SetShadingRatePalette(u32 viewportIndex, TMemoryView<const EShadingRatePalette> value) = 0;
