...
struct FDeviceProperties {
    ...
    uint2   ShadingRateTexelSize;                       // indicates the width and height of the portion of the framebuffer corresponding to each texel in the shading rate image.
    u32     ShadingRatePaletteSize;                     // indicates the maximum number of palette entries supported for the shading rate image.
