...
static bool CreateDX11DeviceAndSwapChainIFP_(
    ...
    case DXGI_ERROR_SDK_COMPONENT_MISSING:
        PPE_THROW_IT(FDeviceEncapsulatorException("Windows SDK is not at the correct version", encapsulator->Device()));
    default:
...
void FDX11DeviceWrapper::CheckDeviceErrors(const FDX11DeviceAPIEncapsulator *encapsulator) const {
    ...
    for(u64 i = 0; i < messageCount ; i++)
    {
        ...
        case ::D3D11_MESSAGE_SEVERITY_CORRUPTION:
            ...
            PPE_THROW_IT(FDeviceEncapsulatorException(formatedMessage, encapsulator->Device()));
            break;
        }
    }
...
NO_INLINE void DX11ThrowIfFailed(
    ...
    LOG(Error, L"[D3D11] {0}", formatedMessage);
    PPE_THROW_IT(FDeviceEncapsulatorException(formatedMessage, encapsulator, optionalResource));
}
