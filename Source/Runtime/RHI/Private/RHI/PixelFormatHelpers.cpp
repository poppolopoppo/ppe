...
FPixelFormatInfo EPixelFormat_Infos(EPixelFormat fmt) NOEXCEPT {
    ...
    switch (fmt) {
    case EPixelFormat::RGBA16_SNorm:                return { fmt,16*4,  4, { EType::SNorm, Zero } };
    case EPixelFormat::RGBA8_SNorm:                 return { fmt,8*4,   4, { EType::SNorm, Zero } };
    case EPixelFormat::RGB16_SNorm:                 return { fmt,16*3,  3, { EType::SNorm, Zero } };
    case EPixelFormat::RGB8_SNorm:                  return { fmt,8*3,   3, { EType::SNorm, Zero } };
    case EPixelFormat::RG16_SNorm:                  return { fmt,16*2,  2, { EType::SNorm, Zero } };
    case EPixelFormat::RG8_SNorm:                   return { fmt,8*2,   2, { EType::SNorm, Zero } };
    case EPixelFormat::R16_SNorm:                   return { fmt,16*1,  1, { EType::SNorm, Zero } };
    case EPixelFormat::R8_SNorm:                    return { fmt,8*1,   1, { EType::SNorm, Zero } };
    case EPixelFormat::RGBA16_UNorm:                return { fmt,16*4,  4, { EType::UNorm, Zero } };
    case EPixelFormat::RGBA8_UNorm:                 return { fmt,8*4,   4, { EType::UNorm, Zero } };
    case EPixelFormat::RGB16_UNorm:                 return { fmt,16*3,  3, { EType::UNorm, Zero } };
    case EPixelFormat::RGB8_UNorm:                  return { fmt,8*3,   3, { EType::UNorm, Zero } };
    case EPixelFormat::RG16_UNorm:                  return { fmt,16*2,  2, { EType::UNorm, Zero } };
    case EPixelFormat::RG8_UNorm:                   return { fmt,8*2,   2, { EType::UNorm, Zero } };
    case EPixelFormat::R16_UNorm:                   return { fmt,16*1,  1, { EType::UNorm, Zero } };
    case EPixelFormat::R8_UNorm:                    return { fmt,8*1,   1, { EType::UNorm, Zero } };
    case EPixelFormat::RGB10_A2_UNorm:              return { fmt,10*3+2,4, { EType::UNorm, Zero } };
    case EPixelFormat::RGBA4_UNorm:                 return { fmt,4*4,   4, { EType::UNorm, Zero } };
    case EPixelFormat::RGB5_A1_UNorm:               return { fmt,5*3+1, 4, { EType::UNorm, Zero } };
    case EPixelFormat::RGB_5_6_5_UNorm:             return { fmt,5+6+5, 3, { EType::UNorm, Zero } };
    case EPixelFormat::BGR8_UNorm:                  return { fmt,8*3,   3, { EType::UNorm, Zero } };
    case EPixelFormat::BGRA8_UNorm:                 return { fmt,8*4,   4, { EType::UNorm, Zero } };
    ...
    case EPixelFormat::R8i:                         return { fmt,8*1,   1, { EType::Int, Zero } };
    case EPixelFormat::RG8i:                        return { fmt,8*2,   2, { EType::Int, Zero } };
    case EPixelFormat::RGB8i:                       return { fmt,8*3,   3, { EType::Int, Zero } };
    case EPixelFormat::RGBA8i:                      return { fmt,8*4,   4, { EType::Int, Zero } };
    case EPixelFormat::R16i:                        return { fmt,16*1,  1, { EType::Int, Zero } };
    case EPixelFormat::RG16i:                       return { fmt,16*2,  2, { EType::Int, Zero } };
    case EPixelFormat::RGB16i:                      return { fmt,16*3,  3, { EType::Int, Zero } };
    case EPixelFormat::RGBA16i:                     return { fmt,16*4,  4, { EType::Int, Zero } };
    case EPixelFormat::R32i:                        return { fmt,32*1,  1, { EType::Int, Zero } };
    case EPixelFormat::RG32i:                       return { fmt,32*2,  2, { EType::Int, Zero } };
    case EPixelFormat::RGB32i:                      return { fmt,32*3,  3, { EType::Int, Zero } };
    case EPixelFormat::RGBA32i:                     return { fmt,32*4,  4, { EType::Int, Zero } };
    case EPixelFormat::R8u:                         return { fmt,8*1,   1, { EType::UInt, Zero } };
    case EPixelFormat::RG8u:                        return { fmt,8*2,   2, { EType::UInt, Zero } };
    case EPixelFormat::RGB8u:                       return { fmt,8*3,   3, { EType::UInt, Zero } };
    case EPixelFormat::RGBA8u:                      return { fmt,8*4,   4, { EType::UInt, Zero } };
    case EPixelFormat::R16u:                        return { fmt,16*1,  1, { EType::UInt, Zero } };
    case EPixelFormat::RG16u:                       return { fmt,16*2,  2, { EType::UInt, Zero } };
    case EPixelFormat::RGB16u:                      return { fmt,16*3,  3, { EType::UInt, Zero } };
    case EPixelFormat::RGBA16u:                     return { fmt,16*4,  4, { EType::UInt, Zero } };
    case EPixelFormat::R32u:                        return { fmt,32*1,  1, { EType::UInt, Zero } };
    case EPixelFormat::RG32u:                       return { fmt,32*2,  2, { EType::UInt, Zero } };
    case EPixelFormat::RGB32u:                      return { fmt,32*3,  3, { EType::UInt, Zero } };
    case EPixelFormat::RGBA32u:                     return { fmt,32*4,  4, { EType::UInt, Zero } };
    case EPixelFormat::RGB10_A2u:                   return { fmt,10*3+2,4, { EType::UInt, Zero } };
    case EPixelFormat::R16f:                        return { fmt,16*1,  1, { EType::SFloat, Zero } };
    case EPixelFormat::RG16f:                       return { fmt,16*2,  2, { EType::SFloat, Zero } };
    case EPixelFormat::RGB16f:                      return { fmt,16*3,  3, { EType::SFloat, Zero } };
    case EPixelFormat::RGBA16f:                     return { fmt,16*4,  4, { EType::SFloat, Zero } };
    case EPixelFormat::R32f:                        return { fmt,32*1,  1, { EType::SFloat, Zero } };
    case EPixelFormat::RG32f:                       return { fmt,32*2,  2, { EType::SFloat, Zero } };
    case EPixelFormat::RGB32f:                      return { fmt,32*3,  3, { EType::SFloat, Zero } };
    case EPixelFormat::RGBA32f:                     return { fmt,32*4,  4, { EType::SFloat, Zero } };
    case EPixelFormat::RGB_11_11_10f:               return { fmt,11+11+10,3, { EType::SFloat, Zero } };
    case EPixelFormat::Depth16:                     return { fmt,{16, 0}, { EType::UNorm  | EType::Depth, Zero }, EImageAspect::Depth };
    case EPixelFormat::Depth24:                     return { fmt,{24, 0}, { EType::UNorm  | EType::Depth, Zero }, EImageAspect::Depth };
    case EPixelFormat::Depth32f:                    return { fmt,{32, 0}, { EType::SFloat | EType::Depth, Zero }, EImageAspect::Depth };
    case EPixelFormat::Depth16_Stencil8:            return { fmt,{16, 8}, { EType::UNorm  | EType::DepthStencil, Zero }, EImageAspect_DepthStencil };
    case EPixelFormat::Depth24_Stencil8:            return { fmt,{24, 8}, { EType::UNorm  | EType::DepthStencil, Zero }, EImageAspect_DepthStencil };
    case EPixelFormat::Depth32F_Stencil8:           return { fmt,{32, 8}, { EType::SFloat | EType::DepthStencil, Zero }, EImageAspect_DepthStencil };
    case EPixelFormat::BC1_RGB8_UNorm:              return { fmt,64,    {4,4},  3, { EType::UNorm, Zero } };
    case EPixelFormat::BC1_sRGB8:                   return { fmt,64,    {4,4},  3, { EType::UNorm, EType::sRGB } };
    case EPixelFormat::BC1_RGB8_A1_UNorm:           return { fmt,64,    {4,4},  4, { EType::UNorm, Zero } };
    ...
    case EPixelFormat::BC5_RG8_UNorm:               return { fmt,128,   {4,4},  2, { EType::UNorm, Zero } };
    case EPixelFormat::BC7_RGBA8_UNorm:             return { fmt,128,   {4,4},  4, { EType::UNorm, Zero } };
    case EPixelFormat::BC7_sRGB8_A8:                return { fmt,128,   {4,4},  4, { EType::UNorm, EType::sRGB } };
    case EPixelFormat::BC6H_RGB16F:                 return { fmt,128,   {4,4},  3, { EType::SFloat, Zero } };
    case EPixelFormat::BC6H_RGB16UF:                return { fmt,128,   {4,4},  3, { EType::UInt, Zero } };
    case EPixelFormat::ETC2_RGB8_UNorm:             return { fmt,64,    {4,4},  3, { EType::UNorm, Zero } };
    case EPixelFormat::ECT2_sRGB8:                  return { fmt,64,    {4,4},  3, { EType::UNorm, EType::sRGB } };
    case EPixelFormat::ETC2_RGB8_A1_UNorm:          return { fmt,64,    {4,4},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ETC2_sRGB8_A1:               return { fmt,64,    {4,4},  4, { EType::UNorm, EType::sRGB } };
    case EPixelFormat::ETC2_RGBA8_UNorm:            return { fmt,128,   {4,4},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ETC2_sRGB8_A8:               return { fmt,128,   {4,4},  4, { EType::UNorm, EType::sRGB } };
    case EPixelFormat::EAC_R11_SNorm:               return { fmt,64,    {4,4},  1, { EType::SNorm, Zero } };
    case EPixelFormat::EAC_R11_UNorm:               return { fmt,64,    {4,4},  1, { EType::UNorm, Zero } };
    case EPixelFormat::EAC_RG11_SNorm:              return { fmt,128,   {4,4},  2, { EType::SNorm, Zero } };
    case EPixelFormat::EAC_RG11_UNorm:              return { fmt,128,   {4,4},  2, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_4x4:               return { fmt,128,   {4,4},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_5x4:               return { fmt,128,   {5,4},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_5x5:               return { fmt,128,   {5,5},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_6x5:               return { fmt,128,   {6,5},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_6x6:               return { fmt,128,   {6,6},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_8x5:               return { fmt,128,   {8,5},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_8x6:               return { fmt,128,   {8,6},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_8x8:               return { fmt,128,   {8,8},  4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_10x5:              return { fmt,128,   {10,5}, 4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_10x6:              return { fmt,128,   {10,6}, 4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_10x8:              return { fmt,128,   {10,8}, 4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_10x10:             return { fmt,128,   {10,10},4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_12x10:             return { fmt,128,   {12,10},4, { EType::UNorm, Zero } };
    case EPixelFormat::ASTC_RGBA_12x12:             return { fmt,128,   {12,12},4, { EType::UNorm, Zero } };
