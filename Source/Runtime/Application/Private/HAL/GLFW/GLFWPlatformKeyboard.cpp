...
struct FGLFWWindow::FKeyboardCallbacks {
    ...
    #define PPE_GLFW_KEYBOARDKEY_DEF(GLFW, EKey) \
        ...
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_T, _T)
        ...
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_KP_ADD, Plus)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_KP_SUBTRACT, Minus)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_KP_MULTIPLY, Asterix)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_KP_DIVIDE, Slash)
        ...
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_UP, UpArrow)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_DOWN, DownArrow)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_LEFT, LeftArrow)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_RIGHT, RightArrow)
        ...
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_LEFT_ALT, LeftAlt)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_RIGHT_ALT, RightAlt)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_LEFT_CONTROL, LeftControl)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_RIGHT_CONTROL, RightControl)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_LEFT_SHIFT, LeftShift)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_RIGHT_SHIFT, RightShift)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_LEFT_SUPER, LeftSuper)
        PPE_GLFW_KEYBOARDKEY_DEF(GLFW_KEY_RIGHT_SUPER, RightSuper)
