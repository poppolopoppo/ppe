...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
class PPE_RHIVULKAN_API FVulkanDeviceException : public FVulkanException {
public:
    FVulkanDeviceException(const char* what, long errorCode) : FVulkanException(what, errorCode) {}
};
//----------------------------------------------------------------------------
class PPE_RHIVULKAN_API FVulkanGroupException : public FVulkanException {
public:
    FVulkanGroupException(const char* what, long errorCode) : FVulkanException(what, errorCode) {}
};
//----------------------------------------------------------------------------
class PPE_RHIVULKAN_API FVulkanInstanceException : public FVulkanException {
public:
