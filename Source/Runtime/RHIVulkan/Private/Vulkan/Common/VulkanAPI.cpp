...
TBasicTextWriter<_Char>& ToStream_(TBasicTextWriter<_Char>& oss, EVulkanVendor vendor) {
    switch (vendor) {
    case EVulkanVendor::AMD: oss << STRING_LITERAL(_Char, "AMD"); break;
    case EVulkanVendor::ImgTec: oss << STRING_LITERAL(_Char, "ImgTec"); break;
    case EVulkanVendor::NVIDIA: oss << STRING_LITERAL(_Char, "NVIDIA"); break;
    case EVulkanVendor::ARM: oss << STRING_LITERAL(_Char, "ARM"); break;
    case EVulkanVendor::Qualcomm: oss << STRING_LITERAL(_Char, "Qualcomm"); break;
    case EVulkanVendor::INTEL: oss << STRING_LITERAL(_Char, "INTEL"); break;
    case EVulkanVendor::Unknown: oss << STRING_LITERAL(_Char, "Unknown"); break;
    }
    return oss;
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
FTextWriter& operator <<(FTextWriter& oss, EVulkanVendor vendor) { return ToStream_(oss, vendor); }
FWTextWriter& operator <<(FWTextWriter& oss, EVulkanVendor vendor) {  return ToStream_(oss, vendor);  }
//----------------------------------------------------------------------------
EVulkanVendor FVulkanInstanceFunctions::IdentifyVendorId(u32 vendorId) NOEXCEPT {
    switch (vendorId) {
    case u32(EVulkanVendor::AMD): return EVulkanVendor::AMD;
    case u32(EVulkanVendor::ImgTec): return EVulkanVendor::ImgTec;
    case u32(EVulkanVendor::NVIDIA): return EVulkanVendor::NVIDIA;
    case u32(EVulkanVendor::ARM): return EVulkanVendor::ARM;
    case u32(EVulkanVendor::Qualcomm): return EVulkanVendor::Qualcomm;
    case u32(EVulkanVendor::INTEL): return EVulkanVendor::INTEL;
    default:
