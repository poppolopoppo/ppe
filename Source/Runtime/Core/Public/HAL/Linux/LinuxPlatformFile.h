...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
struct PPE_CORE_API FLinuxPlatformFile : FGenericPlatformFile {
public:
    STATIC_CONST_INTEGRAL(bool, IsCaseSensitive, true);

    STATIC_CONST_INTEGRAL(size_t, MaxPathDepth, 32);
    STATIC_CONST_INTEGRAL(size_t, MaxPathLength, PATH_MAX);
