...
struct ALIGN(16) FByteMask16 {
    ...
    FORCE_INLINE void VECTORCALL broadcast(u8 v) NOEXCEPT {
        xmm = ::_mm_set1_epi8(v);
    }
    FORCE_INLINE void VECTORCALL setzero() NOEXCEPT {
        xmm = ::_mm_setzero_si128();
    }

    FORCE_INLINE void VECTORCALL set_false() NOEXCEPT {
        xmm = ::_mm_setzero_si128();
    }
    FORCE_INLINE void VECTORCALL set_true() NOEXCEPT {
        xmm = ::_mm_cmpeq_epi32(::_mm_setzero_si128(), ::_mm_setzero_si128());
    }
    FORCE_INLINE void VECTORCALL set_true_after(i8 i) NOEXCEPT {
        xmm = ::_mm_cmpgt_epi8(::_mm_set1_epi8(i), ::_mm_set_epi64x(0x0f0e0d0c0b0a0908ULL, 0x0706050403020100ULL));
    }

    FORCE_INLINE void VECTORCALL load(const void* src) NOEXCEPT {
        xmm = ::_mm_load_si128((const m128i_t*)src);
    }
    FORCE_INLINE void VECTORCALL store(void* dst) const NOEXCEPT {
        ::_mm_store_si128((m128i_t*)dst, xmm);
    }

    FORCE_INLINE FByteMask16 VECTORCALL cmpeq(FByteMask16 other) const NOEXCEPT {
        return { ::_mm_cmpeq_epi8(xmm, other.xmm) };
    }

    FORCE_INLINE u32 VECTORCALL move_mask() const NOEXCEPT {
        return u32(::_mm_movemask_epi8(xmm));
    }

    FORCE_INLINE void VECTORCALL mask_move(u16 m) NOEXCEPT {
    ...
    FORCE_INLINE FByteMask16 VECTORCALL select(FByteMask16 if_true, FByteMask16 if_false) const NOEXCEPT {
#if 0
    ...
    FORCE_INLINE m128i_t VECTORCALL tzcnt_mask(m128i_t mask_epi8) {
    ...
    FORCE_INLINE u32 VECTORCALL replace_first_assume_unique(FByteMask16 hold, FByteMask16 hnew) NOEXCEPT {
    ...
    FORCE_INLINE u32 VECTORCALL replace_first_loop(FByteMask16& visited, FByteMask16 hold, FByteMask16 hnew) NOEXCEPT {
    ...
    FORCE_INLINE u32 VECTORCALL find(FByteMask16 h) const NOEXCEPT {
        return u32(::_mm_movemask_epi8(::_mm_cmpeq_epi8(xmm, h.xmm)));
    }
    FORCE_INLINE u32 VECTORCALL find_after(FByteMask16 h, i8 i) const NOEXCEPT {
        return u32(::_mm_movemask_epi8(::_mm_and_si128(
            ::_mm_cmpeq_epi8(xmm, h.xmm),
            ::_mm_cmpgt_epi8(::_mm_set_epi64x(0x0f0e0d0c0b0a0908ULL, 0x0706050403020100ULL), ::_mm_set1_epi8(i)) )));
    }

    FORCE_INLINE u32 VECTORCALL find_not(FByteMask16 h) const NOEXCEPT {
        return u32(::_mm_movemask_epi8(::_mm_cmpeq_epi8(
            ::_mm_cmpeq_epi8(xmm, h.xmm), ::_mm_setzero_si128()) ));
    }
    FORCE_INLINE u32 VECTORCALL find_not_after(FByteMask16 h, i8 i) const NOEXCEPT {
        ...
        return u32(::_mm_movemask_epi8(::_mm_andnot_si128(mskeq, after)));
    }

    FORCE_INLINE void VECTORCALL remove_at(u32 i) NOEXCEPT {
    ...
    FORCE_INLINE u32 VECTORCALL clear_move(FByteMask16 hdeleted) NOEXCEPT {
        const u32 bitmask = find_not(hdeleted);
        xmm = hdeleted.xmm;
        return bitmask;
    }
