...
struct TCompressedPairElement {
    ...
    template <typename _Dummy = T, Meta::TEnableIf<std::is_default_constructible_v<_Dummy>>* = nullptr >
    CONSTEXPR TCompressedPairElement() NOEXCEPT_IF(std::is_nothrow_default_constructible_v<T>)
    {}

    template <typename _Arg, Meta::TEnableIf<
        std::is_constructible_v<T, _Arg&&> and
        not std::is_same_v<std::remove_cv_t<std::remove_reference_t<_Arg>>, TCompressedPairElement>>* = nullptr >
...
struct TCompressedPairElement<T, _Tag, Meta::TEnableIf<Meta::is_ebco_eligible_v<T>>> : T {
    ...
    template <typename _Arg, Meta::TEnableIf<!std::is_same_v<std::remove_cv_t<std::remove_reference_t<_Arg>>, TCompressedPairElement>>* = nullptr >
...
class EMPTY_BASES TCompressedPair final
...
public:
    ...
    CONSTEXPR TCompressedPair(std::piecewise_construct_t, std::tuple<_Args...> args, std::tuple<_Other...> other) NOEXCEPT_IF(std::is_nothrow_constructible_v<first_elt_t, _Args...>&& std::is_nothrow_constructible_v<second_elt_t, _Other...>)
