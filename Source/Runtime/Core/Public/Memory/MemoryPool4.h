...
class CACHELINE_ALIGNED TMemoryPool4 : Meta::FNonCopyableNorMovable {
public:
    ...
    explicit TMemoryPool4(_Allocator&& ralloc) : _pool(std::move(ralloc)) {
        InitializeInternalPool_(*_pool.LockExclusive());
    }
    explicit TMemoryPool4(const _Allocator& alloc) : _pool(alloc) {
        InitializeInternalPool_(*_pool.LockExclusive());
    }
...
private:
    ...
    struct FInternalPool_ : _Allocator {
        ...
        mutable FMemoryTracking TrackingData{
            Meta::type_info<TMemoryPool4>.name,
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::~TMemoryPool4() {
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
void TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::InitializeInternalPool_(FInternalPool_& pool) {
    STATIC_ASSERT(std::atomic<index_type>::is_always_lock_free);
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
auto TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::Allocate(u32 bucket) -> index_type {
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
void TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::Deallocate(index_type block, u32 bucket) {
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
void TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::Clear_AssertCompletelyEmpty() {
    const auto exclusivePool = _pool.LockExclusive();
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
void TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::Clear_IgnoreLeaks() {
    Clear_ReleaseMemory_AssumeLocked_(*_pool.LockExclusive());
}
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
void TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::Clear_ReleaseMemory_AssumeLocked_(FInternalPool_& pool) {
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
void TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::ReleaseCacheMemory() {
    const auto exclusivePool = _pool.LockExclusive();
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
auto TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::AllocateFromNewBundle_AssumeUnlocked_(u32 firstBucket) -> index_type {
    const auto exclusivePool = _pool.LockExclusive();
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
void TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::RecyclePartialBundle_AssumeUnlocked_(u32 bucket, index_type block, FPoolNode_* node) {
    Assert(node);
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
void TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::FFreeBlockList_::PushBundle(FPoolBundle_&& rbundle) {
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
auto TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::FFreeBlockList_::PopBundles(FPoolChunk_** pChunks) -> index_type {
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
bool TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::FFreeBlockList_::ObtainPartial(FPoolChunk_** pChunks, FBundleRecycler_& recycler) {
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
auto TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::FFreeBlockList_::RecycleFull(FPoolChunk_** pChunks, FBundleRecycler_& recycler) -> index_type {
    index_type needRecycling = UMax;
...
//----------------------------------------------------------------------------
template <size_t _BlockSize, size_t _Align, size_t _ChunkSize, size_t _MaxChunks, size_t _Granularity, typename _Allocator>
bool TMemoryPool4<_BlockSize, _Align, _ChunkSize, _MaxChunks, _Granularity, _Allocator>::CheckInvariants() const {
#if USE_PPE_DEBUG

    const auto exclusivePool = const_cast<TMemoryPool4*>(this)->_pool.LockExclusive();
...
class TTypedMemoryPool4 : public TMemoryPool4<sizeof(T), alignof(T), _ChunkSize, _MaxChunks, _Granularity, _Allocator> {
    using parent_type = TMemoryPool4<sizeof(T), alignof(T), _ChunkSize, _MaxChunks, _Granularity, _Allocator>;
public:
