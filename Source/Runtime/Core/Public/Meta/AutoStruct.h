...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
#define _PPE_DETAILS_AUTOSTRUCT_DEFINE(_FIELD_TYPE, _FIELD_NAME, ...) _FIELD_TYPE _FIELD_NAME __VA_ARGS__;
...
#define PPE_AUTOSTRUCT_MEMBERS(_STRUCT_NAME, ...) \
    ...
    NODISCARD friend bool operator !=(const _STRUCT_NAME& lhs, const _STRUCT_NAME& rhs) NOEXCEPT { return not operator ==(lhs, rhs); } \
    NODISCARD friend bool operator ==(const _STRUCT_NAME& lhs, const _STRUCT_NAME& rhs) NOEXCEPT { \
        PPE::Unused(lhs, rhs); /* empty struct */ \
        return (true PP_FOREACH_TUPLE(_PPE_DETAILS_AUTOSTRUCT_EQUALS, __VA_ARGS__)); \
    } \
    NODISCARD friend PPE::hash_t hash_value(const _STRUCT_NAME& value) NOEXCEPT { \
        PPE::Unused(value); /* empty struct */ \
