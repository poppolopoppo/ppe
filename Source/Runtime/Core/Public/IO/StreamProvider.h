...
//----------------------------------------------------------------------------
class PPE_API IBufferedStreamReader : public IStreamReader {
...
//----------------------------------------------------------------------------
class PPE_API IBufferedStreamWriter : public IStreamWriter {
...
//----------------------------------------------------------------------------
class PPE_API EMPTY_BASES IStreamReadWriter : public IStreamReader, public IStreamWriter {
public:
