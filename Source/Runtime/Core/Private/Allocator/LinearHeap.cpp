...
//----------------------------------------------------------------------------
#define WITH_PPE_LINEARHEAP_FALLBACK_TO_MALLOC (USE_PPE_MEMORY_DEBUGGING)
...
#if defined(USE_DEBUG_LOGGER) && USE_PPE_MEMORYDOMAINS
...
#   endif //!WITH_PPE_LINEARHEAP_FALLBACK_TO_MALLOC
#endif //!defined(USE_DEBUG_LOGGER) && USE_PPE_MEMORYDOMAINS
}
