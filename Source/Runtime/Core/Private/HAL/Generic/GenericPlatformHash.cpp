...
//----------------------------------------------------------------------------
static u32 CRC32_SlicingBy8_(u32 crc, const u8* buf, size_t len) {
...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
u32 FGenericPlatformHash::CRC32(u32 seed, const void* p, size_t size) NOEXCEPT {
    Assert(p);
...
u32 FGenericPlatformHash::Fingeprint32(const void* p, size_t size) NOEXCEPT {
    ...
    return FarmHash::Fingerprint32(reinterpret_cast<const char *>(p), size);
}
//----------------------------------------------------------------------------
u64 FGenericPlatformHash::Fingeprint64(const void* p, size_t size) NOEXCEPT {
    Assert(p);

    return FarmHash::Fingerprint64(reinterpret_cast<const char *>(p), size);
}
//----------------------------------------------------------------------------
u128 FGenericPlatformHash::Fingeprint128(const void* p, size_t size) NOEXCEPT {
    Assert(p);

    FarmHash::uint128_t h;
    h = FarmHash::Fingerprint128(reinterpret_cast<const char *>(p), size);
