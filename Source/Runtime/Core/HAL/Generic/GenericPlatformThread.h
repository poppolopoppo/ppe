...
//----------------------------------------------------------------------------
struct CORE_API FGenericPlatformThread {
public: // must be defined for every platform
    ...
    STATIC_ASSERT(CORE_MAX_NUMCORES <= sizeof(FAffinityMask)<<3); // should change FAffinityMask type otherwise
    ...
    struct FThreadGroupInfo {
        ...
        FAffinityMask Affinities[CORE_MAX_NUMCORES] = { AllThreadsAffinity };
    };
