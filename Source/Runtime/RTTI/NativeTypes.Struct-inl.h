...
#include "Core.RTTI/NativeTypes.Tuple-inl.h" // TBaseTupleTraits<...>

#include "Core/Container/Tuple.h"

// need C++17 structured bindings
#define USE_CORE_RTTI_STRUCT_AS_TUPLE _HAS_CXX17

#if USE_CORE_RTTI_STRUCT_AS_TUPLE
...
#endif //!USE_CORE_RTTI_STRUCT_AS_TUPLE
