...
void TMetaTypeTraitsImpl< Core::TToken<_Tag, _Char, _Sensitive, _TokenTraits> >::WrapMove(wrapper_type& dst, wrapped_type&& src) {
    dst = src.c_str();
}
//----------------------------------------------------------------------------
template <typename _Tag, typename _Char, ECase _Sensitive, typename _TokenTraits>
void TMetaTypeTraitsImpl< Core::TToken<_Tag, _Char, _Sensitive, _TokenTraits> >::WrapCopy(wrapper_type& dst, const wrapped_type& src) {
    dst = src.c_str();
}
//----------------------------------------------------------------------------
template <typename _Tag, typename _Char, ECase _Sensitive, typename _TokenTraits>
void TMetaTypeTraitsImpl< Core::TToken<_Tag, _Char, _Sensitive, _TokenTraits> >::UnwrapMove(wrapped_type& dst, wrapper_type&& src) {
    dst = src;
}
//----------------------------------------------------------------------------
template <typename _Tag, typename _Char, ECase _Sensitive, typename _TokenTraits>
void TMetaTypeTraitsImpl< Core::TToken<_Tag, _Char, _Sensitive, _TokenTraits> >::UnwrapCopy(wrapped_type& dst, const wrapper_type& src) {
    dst = src;
}
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
