...
#include "Core.RTTI/NativeTypes.Scalar-inl.h"
#include "Core.RTTI/NativeTypes.Tuple-inl.h"
#include "Core.RTTI/NativeTypes.List-inl.h"
#include "Core.RTTI/NativeTypes.Dico-inl.h"
#include "Core.RTTI/NativeTypes.Struct-inl.h"
