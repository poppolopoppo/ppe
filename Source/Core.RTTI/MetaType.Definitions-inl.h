...
#define FOREACH_CORE_RTTI_NATIVE_TYPES(_Macro, ...) \
    ...
    COMMA_PROTECT(_Macro(String,     Core::String,                  33, ##__VA_ARGS__)) \
    COMMA_PROTECT(_Macro(WString,    Core::WString,                 34, ##__VA_ARGS__)) \
    ...
    COMMA_PROTECT(_Macro(Name,       Core::RTTI::Name,              37, ##__VA_ARGS__)) \
    COMMA_PROTECT(_Macro(BinaryData, Core::RTTI::BinaryData,        38, ##__VA_ARGS__)) \
    COMMA_PROTECT(_Macro(OpaqueData, Core::RTTI::OpaqueData,        39, ##__VA_ARGS__))
