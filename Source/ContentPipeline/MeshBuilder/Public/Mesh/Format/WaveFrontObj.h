...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
class FWaveFrontObj final : public IMeshFormat {
public:
    ...
    NODISCARD PPE_MESHBUILDER_API static bool Load(FGenericMesh* dst, const FFilename& filename, IStreamReader& reader);
