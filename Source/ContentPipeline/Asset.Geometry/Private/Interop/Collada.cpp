...
namespace {
//----------------------------------------------------------------------------
#define FOREACH_PPE_LATTICE_COLLADATOKEN(_Macro, ...) \
...
FOREACH_PPE_LATTICE_COLLADATOKEN(COLLADATOKEN_DEF)
...
FOREACH_PPE_LATTICE_COLLADATOKEN(COLLADATOKEN_START)
...
FOREACH_PPE_LATTICE_COLLADATOKEN(COLLADATOKEN_SHUTDOWN)
#undef COLLADATOKEN_SHUTDOWN
}
//----------------------------------------------------------------------------
} //!namespace DAE
//----------------------------------------------------------------------------
#undef FOREACH_PPE_LATTICE_COLLADATOKEN
//----------------------------------------------------------------------------
} //!namespace
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
