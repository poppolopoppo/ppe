...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
bool Compiler_Annotation3_(FWindowTestApp& app) {
...
ARGS_IF_RHIDEBUG("Compiler_Annotation3_CS"));
    ...
    PPE_LOG_CHECK(WindowTest, TestBufferUniform(*ds, "UB"_uniform, 64_b, 1, EShaderStages::Compute, 1, 1));
    PPE_LOG_CHECK(WindowTest, TestStorageBuffer(*ds, "SSB"_uniform, 64_b, 0, EShaderAccess::WriteDiscard, 0, EShaderStages::Compute, 1, 0));
