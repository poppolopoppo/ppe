...
public:
    ...
    EShaderDebugIndex AppendShaderForDebug(TMemoryView<const FRectangle2u>& regions, const FTaskName& name, const FGraphicsShaderDebugMode& mode, size_t size = DebugBufferSize);
