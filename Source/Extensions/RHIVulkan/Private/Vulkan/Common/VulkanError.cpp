...
static TBasicTextWriter<_Char>& VkResultToTextWriter_(TBasicTextWriter<_Char>& oss, const FVulkanError& error) {
    ...
    case VK_ERROR_COMPRESSION_EXHAUSTED_EXT: return oss << STRING_LITERAL(_Char, "VK_ERROR_COMPRESSION_EXHAUSTED_EXT");
    case VK_ERROR_INVALID_VIDEO_STD_PARAMETERS_KHR: return oss << STRING_LITERAL(_Char, "VK_ERROR_INVALID_VIDEO_STD_PARAMETERS_KHR");
    case VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR: return oss << STRING_LITERAL(_Char, "VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR");
    case VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR: return oss << STRING_LITERAL(_Char, "VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR");
    case VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR: return oss << STRING_LITERAL(_Char, "VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR");
    case VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR: return oss << STRING_LITERAL(_Char, "VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR");
    case VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR: return oss << STRING_LITERAL(_Char, "VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR");
    case VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR: return oss << STRING_LITERAL(_Char, "VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR");
    case VK_INCOMPATIBLE_SHADER_BINARY_EXT: return oss << STRING_LITERAL(_Char, "VK_INCOMPATIBLE_SHADER_BINARY_EXT");
