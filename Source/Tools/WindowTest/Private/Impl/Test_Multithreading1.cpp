...
ARGS_IF_RHIDEBUG("Test_Multithreading1_PS"));
    ...
    FTaskFunc tasks[3];
    tasks[0] = [&threadResult1, &context](ITaskContext&) { threadResult1 = context.RenderThread1(); };
    tasks[1] = [&threadResult2, &context](ITaskContext&) { threadResult2 = context.RenderThread2(); };
    tasks[2] = [&threadResult3, &context](ITaskContext&) { threadResult3 = context.RenderThread3(); };
