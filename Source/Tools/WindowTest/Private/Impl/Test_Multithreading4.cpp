...
//----------------------------------------------------------------------------
bool Test_Multithreading4_(FWindowTestApp& app) {
...
ARGS_IF_RHIDEBUG("Test_Multithreading4_VS"));
...
ARGS_IF_RHIDEBUG("Test_Multithreading4_PS"));

    TAutoResource<FGPipelineID> gppln{ *fg, fg->CreatePipeline(gdesc ARGS_IF_RHIDEBUG("Test_Multithreading4_Graphics")) };
...
ARGS_IF_RHIDEBUG("Test_Multithreading4_VS"));
    ...
    TAutoResource<FCPipelineID> cppln{ *fg, fg->CreatePipeline(cdesc ARGS_IF_RHIDEBUG("Test_Multithreading4_Compute")) };
