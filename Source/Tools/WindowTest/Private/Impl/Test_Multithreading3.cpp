...
//----------------------------------------------------------------------------
bool Test_Multithreading3_(FWindowTestApp& app) {
...
ARGS_IF_RHIDEBUG("Test_Multithreading3_VS"));
...
ARGS_IF_RHIDEBUG("Test_Multithreading3_PS"));

    TAutoResource<FGPipelineID> ppln{ *fg, fg->CreatePipeline(desc ARGS_IF_RHIDEBUG("Test_Multithreading3")) };
