...
void main() {
    ...
    LOG_CHECK(WindowTest, ppln.VertexInput("at_MaterialID"_vertex));
    ...
    LOG_CHECK(WindowTest, TestTextureUniform(*ds, "un_ColorTexture"_uniform, EImageSampler::Float2D, 0, EShaderStages::Vertex | EShaderStages::Fragment));
    LOG_CHECK(WindowTest, TestBufferUniform(*ds, "UB"_uniform, 16_b, 1, EShaderStages::Fragment));
