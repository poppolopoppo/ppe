...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
bool Test_DrawMeshes1_(FWindowTestApp& app) {
    using namespace PPE::RHI;

    if (not (app.RHI().Features() & ERHIFeature::MeshDraw)) {
        LOG(WindowTest, Warning, L"Test_DrawMeshes1_: skipped due to lack of mesh shader support");
        return true;
    }
...
ARGS_IF_RHIDEBUG("Test_DrawMeshes_MS"));
...
ARGS_IF_RHIDEBUG("Test_DrawMeshes_PS"));
