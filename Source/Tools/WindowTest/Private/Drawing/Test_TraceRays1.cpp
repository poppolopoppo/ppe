...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
bool Test_TraceRays1_(FWindowTestApp& app) {
    using namespace PPE::RHI;

    if (not (app.RHI().Features() & ERHIFeature::RayTracing)) {
        LOG(WindowTest, Warning, L"Test_TraceRays1_: skipped due to lack of ray tracing support");
        return true;
    }
...
ARGS_IF_RHIDEBUG("Test_TraceRays1_RayGen"));
...
ARGS_IF_RHIDEBUG("Test_TraceRays1_RayMiss"));
