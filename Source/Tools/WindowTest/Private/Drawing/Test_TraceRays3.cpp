...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
bool Test_TraceRays3_(FWindowTestApp& app) {
    using namespace PPE::RHI;

    if (not (app.RHI().Features() & ERHIFeature::RayTracing)) {
        LOG(WindowTest, Warning, L"Test_TraceRays3_: skipped due to lack of ray tracing support");
        return true;
    }
...
ARGS_IF_RHIDEBUG("Test_TraceRays3_RayGen"));
...
ARGS_IF_RHIDEBUG("Test_TraceRays3_RayMiss"));
...
ARGS_IF_RHIDEBUG("Test_TraceRays3_RayClosestHit"));
    ...
    FCommandBufferBatch cmd1{ fg.Begin(FCommandBufferDesc{}
        .SetName("Test_TraceRays3-Frame1")
    ...
    FCommandBufferBatch cmd2{ fg.Begin(FCommandBufferDesc{}
        .SetName("Test_TraceRays3-Frame2")
        .SetDebugFlags(EDebugFlags::Default)) };
