...
/*
  ...
  '----------'---------'----------'---------'
*/
bool Test_AsyncCompute1_(FWindowTestApp& app) {
...
ARGS_IF_RHIDEBUG("Test_AsyncCompute1_VS"));
...
ARGS_IF_RHIDEBUG("Test_AsyncCompute1_PS"));
...
ARGS_IF_RHIDEBUG("Test_AsyncCompute1_CS"));
