...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
bool Test_ArrayOfTextures2_(FWindowTestApp& app) {
...
ARGS_IF_RHIDEBUG("Test_ArrayOfTextures2_CS"));
    ...
    TScopedResource<FSamplerID> sampler{ fg, fg.CreateSampler(FSamplerDesc{} ARGS_IF_RHIDEBUG("Sampler_ArrayOfTextures2")) };
    LOG_CHECK(WindowTest, sampler.Valid());

    TScopedResource<FCPipelineID> ppln{ fg, fg.CreatePipeline(desc ARGS_IF_RHIDEBUG("Test_ArrayOfTextures2")) };
