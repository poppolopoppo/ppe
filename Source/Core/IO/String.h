...
#ifdef DYNAMIC_LINK
#   define EXPORT_CORE_STRING 1
#else
#   define EXPORT_CORE_STRING 0
#endif

#if EXPORT_CORE_STRING
#   include "Core/IO/String-inl.h"
template class CORE_API Core::TBasicString<char>;
template class CORE_API Core::TBasicString<wchar_t>;
#endif
