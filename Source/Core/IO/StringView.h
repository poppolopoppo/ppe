...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API FStringView::iterator StrChr(const FStringView& str, char ch);
CORE_API FStringView::reverse_iterator StrRChr(const FStringView& str, char ch);
//----------------------------------------------------------------------------
CORE_API FWStringView::iterator StrChr(const FWStringView& wstr, wchar_t wch);
CORE_API FWStringView::reverse_iterator StrRChr(const FWStringView& wstr, wchar_t wch);
//----------------------------------------------------------------------------
CORE_API FStringView::iterator StrStr(const FStringView& str, const FStringView& firstOccurence);
CORE_API FWStringView::iterator StrStr(const FWStringView& wstr, const FWStringView& firstOccurence);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API bool IsAlnum(const FStringView& str);
CORE_API bool IsAlnum(const FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API bool IsAlpha(const FStringView& str);
CORE_API bool IsAlpha(const FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API bool IsDigit(const FStringView& str);
CORE_API bool IsDigit(const FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API bool IsXDigit(const FStringView& str);
CORE_API bool IsXDigit(const FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API bool IsIdentifier(const FStringView& str);
CORE_API bool IsIdentifier(const FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API bool IsPrint(const FStringView& str);
CORE_API bool IsPrint(const FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API bool IsSpace(const FStringView& str);
CORE_API bool IsSpace(const FWStringView& wstr);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API FStringView EatAlnums(FStringView& str);
CORE_API FWStringView EatAlnums(FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API FStringView EatAlphas(FStringView& str);
CORE_API FWStringView EatAlphas(FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API FStringView EatDigits(FStringView& str);
CORE_API FWStringView EatDigits(FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API FStringView EatXDigits(FStringView& str);
CORE_API FWStringView EatXDigits(FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API FStringView EatPrints(FStringView& str);
CORE_API FWStringView EatPrints(FWStringView& wstr);
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
CORE_API FStringView Strip(const FStringView& str);
CORE_API FWStringView Strip(const FWStringView& wstr);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API int Compare(const FStringView& lhs, const FStringView& rhs);
CORE_API int Compare(const FWStringView& lhs, const FWStringView& rhs);
//----------------------------------------------------------------------------
CORE_API int CompareI(const FStringView& lhs, const FStringView& rhs);
CORE_API int CompareI(const FWStringView& lhs, const FWStringView& rhs);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API bool EqualsN(const char* lhs, const char* rhs, size_t len);
CORE_API bool EqualsNI(const char* lhs, const char* rhs, size_t len);
//----------------------------------------------------------------------------
CORE_API bool EqualsN(const wchar_t* lhs, const wchar_t* rhs, size_t len);
CORE_API bool EqualsNI(const wchar_t* lhs, const wchar_t* rhs, size_t len);
//----------------------------------------------------------------------------
CORE_API bool Equals(const FStringView& lhs, const FStringView& rhs);
CORE_API bool Equals(const FWStringView& lhs, const FWStringView& rhs);
//----------------------------------------------------------------------------
CORE_API bool EqualsI(const FStringView& lhs, const FStringView& rhs);
CORE_API bool EqualsI(const FWStringView& lhs, const FWStringView& rhs);
//----------------------------------------------------------------------------
...
CORE_API bool StartsWith(const FWStringView& wstr, const FWStringView& wprefix);
//----------------------------------------------------------------------------
CORE_API bool StartsWithI(const FStringView& str, const FStringView& prefix);
CORE_API bool StartsWithI(const FWStringView& wstr, const FWStringView& wprefix);
//----------------------------------------------------------------------------
CORE_API bool EndsWith(const FStringView& str, const FStringView& suffix);
CORE_API bool EndsWith(const FWStringView& wstr, const FWStringView& wsuffix);
//----------------------------------------------------------------------------
CORE_API bool EndsWithI(const FStringView& str, const FStringView& suffix);
CORE_API bool EndsWithI(const FWStringView& wstr, const FWStringView& wsuffix);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API bool Split(FStringView& str, char separator, FStringView& slice);
CORE_API bool Split(FWStringView& wstr, wchar_t separator, FWStringView& slice);
//----------------------------------------------------------------------------
CORE_API bool Split(FStringView& str, const FStringView& separators, FStringView& slice);
CORE_API bool Split(FWStringView& wstr, const FWStringView& separators, FWStringView& slice);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
CORE_API bool Atof(float* dst, const FWStringView& wstr);
CORE_API bool Atod(double* dst, const FWStringView& wstr);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API bool WildMatch(const FStringView& pattern, const FStringView& str);
CORE_API bool WildMatch(const FWStringView& pattern, const FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API bool WildMatchI(const FStringView& pattern, const FStringView& str);
CORE_API bool WildMatchI(const FWStringView& pattern, const FWStringView& wstr);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API size_t EditDistance(const FStringView& lhs, const FStringView& rhs);
CORE_API size_t EditDistance(const FWStringView& lhs, const FWStringView& rhs);
//----------------------------------------------------------------------------
CORE_API size_t EditDistanceI(const FStringView& lhs, const FStringView& rhs);
CORE_API size_t EditDistanceI(const FWStringView& lhs, const FWStringView& rhs);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API size_t Copy(const TMemoryView<char>& dst, const FStringView& src);
CORE_API size_t Copy(const TMemoryView<wchar_t>& dst, const FWStringView& src);
//----------------------------------------------------------------------------
CORE_API const char* NullTerminated(const TMemoryView<char>& dst, const FStringView& src);
CORE_API const wchar_t* NullTerminated(const TMemoryView<wchar_t>& dst, const FWStringView& src);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
CORE_API hash_t hash_string(const FStringView& str);
CORE_API hash_t hash_string(const FWStringView& wstr);
//----------------------------------------------------------------------------
CORE_API hash_t hash_stringI(const FStringView& str);
CORE_API hash_t hash_stringI(const FWStringView& wstr);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
enum class EEscape {
...
//----------------------------------------------------------------------------
CORE_API void Escape(FTextWriter& oss, const FStringView& str, EEscape escape);
CORE_API void Escape(FWTextWriter& oss, const FWStringView& str, EEscape escape);
//----------------------------------------------------------------------------
CORE_API void Escape(FTextWriter& oss, const FStringView& wstr, EEscape escape);
CORE_API void Escape(FWTextWriter& oss, const FWStringView& str, EEscape escape);
//----------------------------------------------------------------------------
CORE_API FTextWriter& operator <<(FTextWriter& oss, const FWStringView& wslice);
CORE_API FWTextWriter& operator <<(FWTextWriter& oss, const FStringView& slice);
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
