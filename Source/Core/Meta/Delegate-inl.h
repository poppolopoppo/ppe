...
template <typename T, typename _Ret, typename... _Args >
template <_Ret (T::*_Member)(_Args... )>
auto TBindDelegate<T *, _Ret (T::*)(_Args... )>::get(T *pcallee) -> type {
    return type(&Wrapper_<_Member>, static_cast<void *>(pcallee));
}
//----------------------------------------------------------------------------
template <typename T, typename _Ret, typename... _Args >
template <_Ret (T::*_Member)(_Args... )>
_Ret TBindDelegate<T *, _Ret (T::*)(_Args... )>::Wrapper_(void *pcallee, _Args... args ) {
    Likely(pcallee);
...
template <typename _Arg0, typename _Ret, typename... _Args >
template <_Ret (*_Func)(_Arg0, _Args... )>
auto TBindDelegate<_Arg0, _Ret (*)(_Arg0, _Args... )>::get(_Arg0&& arg0) -> type {
    arg0_type callee = {0};
...
template <typename _Arg0, typename _Ret, typename... _Args >
template <_Ret (*_Func)(_Arg0, _Args... )>
_Ret TBindDelegate<_Arg0, _Ret (*)(_Arg0, _Args... )>::Wrapper_(void *pcallee, _Args... args ) {
    arg0_type arg0 = {0};
    arg0.raw = pcallee;
...
template <typename _Arg1, typename _Ret, typename _Arg0 >
template <_Ret (*_Func)(_Arg0, _Arg1)>
auto TBindDelegate<_Arg1, _Ret (*)(_Arg0, _Arg1)>::get(_Arg1&& arg1) -> type {
    arg1_type callee = {0};
...
template <typename _Arg1, typename _Ret, typename _Arg0 >
template <_Ret (*_Func)(_Arg0, _Arg1)>
_Ret TBindDelegate<_Arg1, _Ret (*)(_Arg0, _Arg1)>::Wrapper_(void *pcallee, _Arg0 arg0) {
    arg1_type arg1 = {0};
    arg1.raw = pcallee;
...
template <typename _Ret, typename... _Args >
template <_Ret (*_Func)(_Args... )>
auto TBindDelegate<decltype(nullptr), _Ret (*)(_Args... )>::get(void *) -> type {
    return type(&Wrapper_<_Func>, nullptr);
}
//----------------------------------------------------------------------------
template <typename _Ret, typename... _Args >
template <_Ret (*_Func)(_Args... )>
_Ret TBindDelegate<decltype(nullptr), _Ret (*)(_Args... )>::Wrapper_(void *, _Args... args ) {
