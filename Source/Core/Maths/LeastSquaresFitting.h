...
bool LeastSquaresFittingOrthogonalPlane3(class Plane& plane, const MemoryView<const float3>& points);
//----------------------------------------------------------------------------
// TODO
/*
bool LeastSquaresFittingEllipse2(class Plane& plane, const MemoryView<const float3>& points);
bool LeastSquaresFittingEllipsoid3(class Plane& plane, const MemoryView<const float3>& points);
bool LeastSquaresFittingParabloid3(class Plane& plane, const MemoryView<const float3>& points);
*/
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
