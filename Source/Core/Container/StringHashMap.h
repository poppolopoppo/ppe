...
//----------------------------------------------------------------------------
#define STRING_HASHMAP_THREAD_LOCAL(_DOMAIN, _VALUE, _CASE_SENSITIVE) \
    ::Core::TBasicStringHashMap<char, _VALUE, _CASE_SENSITIVE, THREAD_LOCAL_ALLOCATOR(_DOMAIN, ::Core::TPair<::Core::TBasicString<char> COMMA _VALUE>)>
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
#define WSTRING_HASHMAP_THREAD_LOCAL(_DOMAIN, _VALUE, _CASE_SENSITIVE) \
    ::Core::TBasicStringHashMap<wchar_t, _VALUE, _CASE_SENSITIVE, THREAD_LOCAL_ALLOCATOR(_DOMAIN, ::Core::TPair<::Core::TBasicString<wchar_t> COMMA _VALUE>)>
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
#define STRING_HASHMAP_MEMOIZE_THREAD_LOCAL(_DOMAIN, _VALUE, _CASE_SENSITIVE) \
    HASHMAP_THREAD_LOCAL(_DOMAIN, ::Core::TBasicStringHashMemoizer<char COMMA _CASE_SENSITIVE>, _VALUE)
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
#define WSTRING_HASHMAP_MEMOIZE_THREAD_LOCAL(_DOMAIN, _VALUE, _CASE_SENSITIVE) \
    HASHMAP_THREAD_LOCAL(_DOMAIN, ::Core::TBasicStringHashMemoizer<wchar_t COMMA _CASE_SENSITIVE>, _VALUE)
//----------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
} //!namespace Core
