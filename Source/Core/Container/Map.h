...
#define MAP(_DOMAIN, _KEY, _VALUE) \
    ::Core::Map<_KEY, _VALUE, ::Core::Meta::Less<_KEY>, NODEBASED_CONTAINER_ALLOCATOR(_DOMAIN, ::Core::Pair<_KEY COMMA _VALUE>) >
//----------------------------------------------------------------------------
#define MAP_THREAD_LOCAL(_DOMAIN, _KEY, _VALUE) \
    ::Core::Map<_KEY, _VALUE, ::Core::Meta::Less<_KEY>, THREAD_LOCAL_NODEBASED_CONTAINER_ALLOCATOR(_DOMAIN, ::Core::Pair<_KEY COMMA _VALUE>) >
//----------------------------------------------------------------------------
