...
//----------------------------------------------------------------------------
namespace {
/* FOR REFERENCE PURPOSES ONLY, THIS NOT THE VERSION USED
//-----------------------------------------------------------------------------
...
size_t hash_value_as_memory(const void *ptr, size_t sizeInBytes) {
    // using murmur3 hash function, but a more simple version than canonical one
    ...
    STATIC_CONST_INTEGRAL(u32, r1,  15);
    STATIC_CONST_INTEGRAL(u32, r2,  13);
    STATIC_CONST_INTEGRAL(u32, m,   5);
    STATIC_CONST_INTEGRAL(u32, n,   0xe6546b64);
