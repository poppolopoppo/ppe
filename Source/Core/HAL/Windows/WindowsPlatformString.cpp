...
#if USE_CORE_SIMD_STRINGOPS // 2x-3x faster than ::strncmp() == 0
...
#if defined(ARCH_X64) && USE_CORE_SIMD_STRINGOPS // 1x-2x faster with SIMD on x64 :
    size_t fast = len / sizeof(__m128i);
    size_t offset = fast * sizeof(__m128i);
    size_t current_block = 0;
...
#if USE_CORE_SIMD_STRINGOPS // 6x-8x faster with SIMD
