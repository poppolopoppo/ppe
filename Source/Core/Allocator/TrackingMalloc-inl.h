...
#ifdef USE_MEMORY_DOMAINS
    return (tracking_malloc_thread_local)(_MemoryDomain::TrackingData(), size);
#else
...
#ifdef USE_MEMORY_DOMAINS
    return (tracking_calloc_thread_local)(_MemoryDomain::TrackingData(), nmemb, size);
#else
...
#ifdef USE_MEMORY_DOMAINS
    return (tracking_realloc_thread_local)(_MemoryDomain::TrackingData(), ptr, size);
#else
